...
module Google
  module GCOMPUTE
    ...
    class SslCertificate < Chef::Resource
      ...
      property :certificate, String, desired_state: true
      ...
      property :sc_label, String, name_property: true, desired_state: true
      property :private_key, String, desired_state: true
      ...
      action :create do
        ...
        if fetch.nil?
          ...
          @current_resource.certificate =
            ::Google::Compute::Property::String.parse(fetch['certificate'])
          ...
          cannot_change_resource 'SslCertificate cannot be edited'
        end
      end
