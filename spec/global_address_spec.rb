      ...
      context 'no changes == no action' do
        ...
        context 'title == name' do
          ...
          context 'title == name (pass)' do
            ...
            let(:chef_run) do
              r_name = ['gcompute::tests~gcompute_global_address~create~exist',
    ...
    context 'resource missing' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          let(:chef_run) do
            r_name = ['gcompute::tests~gcompute_global_address~create~noexist',
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          let(:chef_run) do
            ...
            r_name = ['gcompute::tests~gcompute_global_address~delete~noexist',
                      '~change~title_eq_name'].join
            runner.converge(r_name) do
              cred = Google::CredentialResourceMock.new('mycred',
                                                        runner.run_context)
    ...
    context 'resource exists' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          let(:chef_run) do
            r_name = ['gcompute::tests~gcompute_global_address~delete~exist',
                      '~change~title_eq_name'].join
            runner.converge(r_name) do
              cred = Google::CredentialResourceMock.new('mycred',
                                                        runner.run_context)
