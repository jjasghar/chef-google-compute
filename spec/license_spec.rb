  ...
  context 'resource exists' do
    ...
    context 'no changes == no action' do
      ...
      context 'title == name (pass)' do
        ...
        let(:chef_run) do
          recipe = ['gcompute::tests~gcompute_license~create~exist~nochange',
                    'title_eq_name'].join('~')
        ...
        context 'gcompute_license[title0]' do
          subject do
            chef_run.find_resource(:gcompute_license, 'title0')
          end
        end

        context 'gcompute_license[title1]' do
          subject do
            chef_run.find_resource(:gcompute_license, 'title1')
          end
        end

        context 'gcompute_license[title2]' do
          subject do
            chef_run.find_resource(:gcompute_license, 'title2')
          end
        end
      end
